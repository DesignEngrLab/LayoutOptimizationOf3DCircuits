...
#include "structs.c"
#include "readwrite.c"
#include "thermal/heatbasic.c"
#include "thermal/heatAPP.c"
#include "thermal/heatMM.c"
#include "thermal/heatSS.c"
...
main()
{
  ...
  printf("\t0. Approximation Method\n");
  printf("\t2. Subspace Method\n");
  printf("\t3. Resistance Network Method\n");
  scanf("%d", &(design->choice));
...
struct Design *design;
{
  ...
  fptr = fopen("output/datafile2", "r");
  if (fptr == NULL)
    {	
      printf("The file called \"output/datafile2\" does not exist or could not be opened.\n\n");
      exit();
    }
  ...
  fptr = fopen("output/datafile1", "r");
  if (fptr == NULL)
    {	
      printf("The file called \"output/datafile1\" does not exist or could not be opened.\n\n");
      exit();
    }
