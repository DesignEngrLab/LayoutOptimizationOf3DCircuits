...
namespace OldThermalPlacementOfComponents
{
...
//                void find_step();
//                void save_design(), save_container(), save_tfield();
...
//fclose(fptr);*/
        ...
        /* ---------------------------------------------------------------------------------- */
            ...
            /*                                       TEST3.C                                      */
            /*                                                                                    */
            /*                   Copyright 1995 Matthew Campbell and Jonathon Cagan               */
            /* ---------------------------------------------------------------------------------- */
...
void init_heat_param();
  ...
  printf("Initializing heat parameters.\n\n");
